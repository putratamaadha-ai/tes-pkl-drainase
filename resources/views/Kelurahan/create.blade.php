...
@section('content')
    <div class="container py-5 main-wrapper">
        ...
        <div class="card card-main p-4">
            <h3 class="fw-bold text-dark mb-3">Tambah Kelurahan Baru</h3>
            <form action="{{ route('kelurahan.store') }}" method="POST" id="formKelurahan">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control rounded-3 @error('nama_kelurahan') is-invalid @enderror" id="nama_kelurahan" name="nama_kelurahan" value="{{ old('nama_kelurahan') }}" placeholder="Contoh: Simpang Tiga" required>
