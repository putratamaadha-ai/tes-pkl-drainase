                    ...
                    <table class="table table-hover align-middle mb-0 text-center">
                        ...
                        <tbody>
                            @forelse($kecamatan as $index => $item)
                                <tr>
                                    <td class="text-muted fw-medium py-2">
                                        {{ $kecamatan->firstItem() + $index }}
                                    </td>

                                    <td class="fw-bold text-start text-dark py-2">
                                        {{ $item->nama_kecamatan }}
                                    </td>
                                    ...
                                    <td class="py-2">
                                        <div class="d-flex gap-1 justify-content-center">
                                            ...
                                            <a href="{{ route('kecamatan.edit', $item->id) }}"
                                                class="btn btn-light btn-sm px-2.5 py-1 text-warning fw-bold border shadow-sm rounded-3 text-decoration-none">
                                                Edit
                                            </a>
                                            ...
                                            <form action="{{ route('kecamatan.destroy', $item->id) }}"
                                                ...
                                                <button type="submit"
                                                    class="btn btn-light btn-sm px-2.5 py-1 text-danger fw-bold border shadow-sm rounded-3">
                                                    Hapus
                                                </button>
